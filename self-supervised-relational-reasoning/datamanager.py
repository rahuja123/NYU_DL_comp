...
class MultiNYU(torch.utils.data.Dataset):
    def __init__(self, root, split, transform, repeat_augmentations,**kwds):
        r"""
        Args:
        ...
        print(root, split, transform, repeat_augmentations)
    ...
    def __getitem__(self, idx):
        ...
        return np.array(img), img_list, target
